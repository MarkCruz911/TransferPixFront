                                ...
                                <div className="single-item user-area">
                                    <div className="profile-area d-flex align-items-center">
                                        <span className="user-profile">
                                            <img className="profile-image" src="src/assets/images/profile.png" alt="User" />
                                        </span>
                        ...
                        <div className="sidebar-wrapper">
                            ...
                            <ul>
                                ...
                                */}
                                <li>
                                    <a href="transactions">
                                        <img src="src/assets/images/icon/transactions.png" alt="Transactions" /> <span>Transacciones</span>
                                    </a>
                                </li>
                                {/*
                                            <li>
                                ...
                                <li>
                                    <a href="transfer">
                                        <img src="src/assets/images/icon/exchange.png" alt="Exchange" /> <span>Enviar Dinero</span>
                                    </a>
                                </li>
                                {/*
                                            <li>
